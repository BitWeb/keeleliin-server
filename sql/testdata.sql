...
INSERT INTO workflow_definition_service (id, workflow_definition_id, service_id) SELECT 1, 1, 1 WHERE NOT EXISTS (SELECT 1 FROM workflow_definition_service WHERE workflow_definition_service.id = 1);
